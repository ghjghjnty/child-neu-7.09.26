...
export default function App() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-amber-300 transition cursor-pointer flex items-center gap-1.5"
            title="Инструкция пользователя и код для GitHub (Скачать ZIP)"
          >
            <BookOpen className="w-4 h-4 text-amber-400" />
            <span className="hidden md:inline text-xs font-semibold">Справка / ZIP</span>
          </button>
      ...
      {/* Модальное окно справки, инструкции и выгрузки проекта для GitHub */}
      <HelpDocsModal
